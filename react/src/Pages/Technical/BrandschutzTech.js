  ...
  return (
    <div className="container">
      ...
      <Box className="pageBox">
        <div
          style={{
            backgroundImage: "url(../tech/brandschutz_tech/brandschutz.png)",
          }}
          className="backgroundImg"
        ></div>
        <div style={{ fontSize: "120%" }}>
          <img
            src="../tech/brandschutz_tech/brandschutz_icon.png"
            className="icon"
            alt=""
          />
          ...
          <div style={{ marginTop: "16%" }}>
            <img
              src="../tech/brandschutz_tech/brandschutz_footer.png"
              className="footerImg"
              alt=""
            />
          </div>
