    ...
    return (
        <div className="container">
            ...
            <Box className="pageBox">
                <div style={{ backgroundImage: "url(../plan/luftung/luftung.png)"}} 
                     className="backgroundImg">
                </div>
                    <div style={{ fontSize: "120%" }}>
                        <img src="../plan/luftung/luftung_icon.png" className="icon" />
                    ...
                    <div style={{ marginTop: "16%" }}>
                        <img src="../plan/luftung/luftung_footer.png" className="footerImg" />
                    </div>
                </div>
            </Box>
        </div>
