...
export default function BetriebPlan() {
    return (
        <div className="container">
            <Header />
            <Box className="pageBox">
                <div style={{ backgroundImage: "url(../plan/betrieb_plan/betrieb.png)"}} 
                     className="backgroundImg">
                </div>
                    <div style={{ fontSize: "120%" }}>
                        <img src="../plan/betrieb_plan/betrieb_icon.png" className="icon" />
                    ...
                    <div style={{ marginTop: "16%" }}>
                        <img src="../plan/betrieb_plan/betrieb_footer.png" className="footerImg" />
                    </div>
                </div>
            </Box>
        </div>
