...
export default function Kühlung() {
    return (
        <div className="container">
            <Header />
            <Box className="pageBox">
                <div style={{ backgroundImage: "url(../plan/kuhlung/kuhlung.png)"}} 
                     className="backgroundImg">
                </div>
                    <div style={{ fontSize: "120%" }}>
                        <img src="../plan/kuhlung/kuhlung_icon.png" className="icon" />
                    ...
                    <div style={{ marginTop: "16%" }}>
                        <img src="../plan/kuhlung/kuhlung_footer.png" className="footerImg" />
                    </div>
                </div>
            </Box>
        </div>
