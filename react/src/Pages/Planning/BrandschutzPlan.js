  ...
  return (
    <div className="container">
      ...
      <Box className="pageBox">
        <div
          style={{
            backgroundImage: "url(../plan/brandschutz_plan/brandschutz.png)",
          }}
          className="backgroundImg"
        ></div>
        <div style={{ fontSize: "120%" }}>
          <img
            src="../plan/brandschutz_plan/brandschutz_icon.png"
            className="icon"
            alt=""
          />
          ...
          <div style={{ marginTop: "16%" }}>
            <img
              src="../plan/brandschutz_plan/brandschutz_footer.png"
              className="footerImg"
              alt=""
            />
          </div>
