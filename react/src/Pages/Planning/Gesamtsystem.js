...
export default function Gesamtsystem() {
    return (
        <div className="container">
            <Header />
            <Box className="pageBox">
                <div style={{ backgroundImage: "url(../plan/gesamtsystem/gesamtsystem.png)"}} 
                     className="backgroundImg">
                </div>
                    <div style={{ fontSize: "120%" }}>
                        <img src="../plan/gesamtsystem/gesamtsystem_icon.png" className="icon" />
                    ...
                    <div style={{ marginTop: "16%" }}>
                        <img src="../plan/gesamtsystem/gesamtsystem_footer.png" className="footerImg" />
                    </div>
                </div>
            </Box>
        </div>
